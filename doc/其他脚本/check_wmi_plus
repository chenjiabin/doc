...
my $conf_file='/opt/plugins/check_wmi_plus.conf';
...
if (! -x $wmic_command) {
   print "This plugin requires the linux implementation of wmic.\nInstall it from the op5 yum repository by executing:\n  yum install wmic.";
   finish_program($ERRORS{'UNKNOWN'});
}
