...
print($status.": ".$available." of ".((keys %ports)-$invalid)." ports available, ".((keys %ports)-$available-$in_use-$invalid)." down, <a href=\"/monitor/op5/portstatus/portstatus.php?hosts=".$hostnames."\">click here to view the report</a>.".$extramsg."\n");
exit $STATUS{$status};
